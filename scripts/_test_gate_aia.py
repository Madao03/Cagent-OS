"""Test: Out-of-list HK stock — 友邦保险 (not in prompt's 10-stock list).

This tests whether the mechanism works or if the prompt list is just a whitelist.
友邦保险 = 1299.HK / AAIGF, pure Hong Kong listing, no mandatory quarterly reports.
"""
import sys, time
